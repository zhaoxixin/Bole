		...
		<div id="header">
			<div class="wrapper">
				...
				<dl class="collapsible_menu">
					...
					<dd><a rel="nofollow" href="${ ctx }/resumeCreate.action">我的简历</a></dd>
				...
				<div class="content_l">
					...
					<div class="profile_box" id="educationalBackground">
						...
						<div class="educationalShow dn">
							<form action="/resumeSave" class="educationalForm borderBtm dn">
					...
					<div class="profile_box" id="worksShow">
						...
						<div class="workEdit dn">
							 <form action="${ctx }/resumeSave.action"  >
								<table>
									<tbody>
										<tr>
											<td>
	...
	<script>
		var ResumeService = {
			init: function() {
				...
				this.userKeys = ['name', 'gender', 'select_topDegree', 'select_workyear', 'currentState', 'email', 'tel', 'pageType'];
				$('.btn_profile_save').on('click', function() {
					self.onSaveBasicInfo();
				});

			},
			initGenderRadio: function() {
				$('#profileGenderRadio li').on('click', function(e) {
			...
			getUserFromForm: function() {
				var params = {};
				$.each(this.userKeys, function(index, key) {
					params[key] = $('#' + key).val();
				});
				return params;
			},
			...
			onSaveBasicInfo: function() {
				// 获取页面信息
				var self = this;
				var params = this.getUserFromForm();
				self.setUserSpan(params);
		...
		<div id="cboxWrapper">
			...
			<div style="clear: left;">
				...
				<div id="cboxContent" style="float: left;">
					...
					<div
					 id="cboxLoadingOverlay" style="float: left;"></div>
