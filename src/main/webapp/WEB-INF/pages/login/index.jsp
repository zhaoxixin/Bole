...
<script type="text/javascript">
	function findJob(industryId, professionId) {
		...
		location.href = '${ctx}/' + city + '/' + industryId + '/'
				+ professionId + '/findJob.action';
		...
		<div id="header">
			<div class="wrapper">
				...
				<ul class="reset" id="navheader">
					...
					<c:if
						test="${sessionScope.user1 == null&& sessionScope.admin == null}">
						<li><a style="color: #12CD57" href="${ctx }/toLogin.action">企业入口</a></li>
					</c:if>
					<li><a style="color: #12CD57" href="${ctx }/companyhome"
						target="_blank">名企专区</a></li>

					<li><a style="color: #12CD57"
						href="${ctx }/resumeCreate.action" rel="nofollow">我的简历</a></li>
					<li><a style="color: #12CD57" href="create.html"
				...
				<ul class="loginTop">
					...
					<c:if
						test="${ sessionScope.user1 == null && sessionScope.admin == null && sessionScope.company==null}">
						<a href="${ctx}/toLogin.action" rel="nofollow"><font
							color="6633745">登录</font></a>&nbsp;&nbsp;|&nbsp;&nbsp;
						<a href="${ctx}/toRegister.action" rel="nofollow"><font
							color="6633745">注册</font></a>
					</c:if>
					<!-- 如果用户已经登陆, 应该提示欢迎xxx回来 -->
					<c:if test="${sessionScope.user1 != null }">
						<font color="6633745">欢迎 ${user1.userInfo.realname }回来</font>
						  &nbsp;|&nbsp;
						<a href="${ctx}/logout.action" rel="nofollow"><font
							color="6633745">退出</font></a>
					</c:if>
					...
					<c:if test="${sessionScope.admin != null }">
						<a href="${ctx}/home.action"><font color="6633745">欢迎
								${admin.userInfo.realname }回来</font></a>
						  &nbsp;|&nbsp;
						<a href="${ctx}/logout.action" rel="nofollow"><font
							color="6633745">退出</font></a>
						 &nbsp;|&nbsp;
			...
			<div class="ct f_l">
				<div class="ct_now" id="ctname">
					<font color="7706625">全国</font>
				</div>
				<div class="ct_swich">
					<span class="ct_nav">[切换城市]</span>
				</div>
				<div class="ct_link">
					<div class="ct_show">
						<span id="closect" class="f_r" title="关闭窗口">X</span><span
							class="f_l">城市列表</span>
					</div>
					<a class="ct_links" href="javascript:">全国</a><a class="ct_links"
						href="javascript:">北京</a><a class="ct_links" href="javascript:">广州</a>
					<a class="ct_links" href="javascript:">东莞</a><a class="ct_links"
						href="javascript:">汕头</a><a class="ct_links" href="javascript:">珠海</a>
					<a class="ct_links" href="javascript:">佛山</a><a class="ct_links"
						href="javascript:">福州</a><a class="ct_links" href="javascript:">南京</a>
					<a class="ct_links" href="javascript:">苏州</a><a class="ct_links"
						href="javascript:">武汉</a><a class="ct_links" href="javascript:">深圳</a>
					<a class="ct_links" href="javascript:">无锡</a><a class="ct_links"
						href="javascript:">西安</a><a class="ct_links" href="javascript:">重庆</a>
					<a class="ct_links" href="javascript:">上海</a><a class="ct_links"
						href="javascript:">成都</a><a class="ct_links" href="javascript:">太原</a>
					<a class="ct_links" href="javascript:">杭州</a><a class="ct_links"
						href="javascript:">济南</a><a class="ct_links" href="javascript:">青岛</a>
					<span class="ct_links"></span><span class="ct_links"></span><span
						class="ct_links"></span><span class="ct_links"></span>
				</div>
			</div>
						...
						<div class="menu_box">
							...
							<div class="menu_sub dn">
								<dl class="reset">
									<dt></dt>
									<dd>
										<c:forEach items="${in.professionList }" var="p"
											varStatus="status">
											<a href="javascript:0"
												onclick="findJob('${in.industryId}','${p.professionId }')">${p.professionName }</a>
										</c:forEach>
									</dd>
								</dl>
							</div>
			...
			<div class="content">
				<div id="search_box">
					<form id="searchForm" name="searchForm"
						action="${ctx }/findJobByName" method="post">
						<ul id="searchType">
							<li data-searchtype="1" class="type_selected">职位</li>
							<li data-searchtype="4">公司</li>
						</ul>
						<div class="searchtype_arrow"></div>
						<input type="text" id="search_input" name="jobName" tabindex="1"
...
.ui-menu-item a {
	...
	overflow: hidden;
				...
				<dl class="hotSearch">
					<dt>热门搜索：</dt>
					<dd>
						<a href="${ctx}/findJobByName?jobName='java'">Java</a>
					</dd>
					<dd>
						<a href="${ctx}/findJobByName?jobName='PHP'">PHP</a>
					</dd>
					<dd>
						<a href="${ctx}/findJobByName?jobName='Android'">Android</a>
					</dd>
					<dd>
						<a href="${ctx}/findJobByName?jobName='iOS'">iOS</a>
					</dd>
					<dd>
						<a href="${ctx}/findJobByName?jobName='前端'">前端</a>
					</dd>
					<dd>
						<a href="${ctx}/findJobByName?jobName='产品经理'">产品经理</a>
					</dd>
					<dd>
						<a href="${ctx}/findJobByName?jobName='UI'">UI</a>
					</dd>
					<dd>
						<a href="${ctx}/findJobByName?jobName='运营'">运营</a>
					</dd>
					<dd>
						<a href="${ctx}/findJobByName?jobName='BD'">BD</a>
					</dd>
					<dd>
						<a href="${ctx}/findJobByName?jobName='实习'">实习</a>
					</dd>
				</dl>
				<div id="home_banner">
					<ul class="banner_bg">
						<li class="banner_bg_1 current"><a
							href="http://www.500d.me/?f=16497" target="_blank"><img
								src="${ctx}/style/images/jianli.jpg" width="612" height="160"
								alt="好买基金——来了就给100万" /></a></li>
						<li class="banner_bg_2"><a
							href="https://www.zhihu.com/topic/19591490/top-answers"
							target="_blank"><img src="${ctx}/style/images/mainshi.jpg"
								width="612" height="160" alt="世界杯放假看球，老板我也要！" /></a></li>
						<li class="banner_bg_3"><a
							href="http://bbs.yingjiesheng.com/thread-7753-1-1.html"
							target="_blank"><img src="${ctx}/style/images/qiuzhi.jpg"
					...
					<div class="banner_control">
						...
						<ul class="thumbs">
							<li class="thumbs_1 current"><i></i> <img
								src="${ctx}/style/images/jianli.jpg" width="113" height="42" />
							</li>
							<li class="thumbs_2"><i></i> <img
								src="${ctx}/style/images/mainshi.jpg" width="113" height="42" />
							</li>
							<li class="thumbs_3"><i></i> <img
								src="${ctx}/style/images/qiuzhi.jpg" width="113" height="42" />
							</li>
						</ul>
					</div>
				</div>
					...
					<dl>
						...
						<dd>
							...
							<a href="http://www.sykong.com/" target="_blank">手游那点事</a> <a
								href="http://www.mycodes.net/" target="_blank">源码之家</a> <span>|</span>
