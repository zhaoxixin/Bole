...
<div id="body">
    ...
    <div class="sidebar">
     ...
     <dl class="company_center_aside">
		<dt>我收到的简历</dt>
		<dd>
		<a href="javascript:void(0)" onclick="location.href='companyResumes.action'">待处理简历</a>
			</dd>
	<dd>
...
<dl class="company_center_aside">
	...
	<dd>
                    ...
                    <dd>
                    	<form action="autoFilterResumes.html" method="get" id="filterForm">
		                    	...
		                    	<div class="filter_actions ">
		                            ...
		                            <span>全选</span>
		                            <a href="javascript:void(0)" onclick="location.href='ms.action'">通知面试</a>
		                        	<a href="javascript:void(0)" onclick="location.href='bhs.action'">不合适</a>
     ...
     <input type="hidden" value="" name="positionId" id="positionId">
			                                ...
			                                <!--开始更改简历显示-->
			                                <c:forEach items="${bhsresumList}" var="r" >
			                                <label class="checkbox">
			                                    <input type="checkbox">
			                                    <i></i>
			                                </label>
			                                <div class="resumeShow">
			                                    ...
			                                    <div class="resumeIntro">
			                                        ...
			                                        <div> 
			                                        	${r.userInfo.realname} / ${r.userInfo.sex} / ${r.userInfo.education}			                                        	/ 			                                        	/ 广州 			                                            			                                        		<br>
			                                            	 |
			                                            			                                        </div>
			                                    ...
			                                    <div class="links">
 												...
 												<a href="javascript:void(0)" onclick="location.href='delresum.action'">删除</a>
